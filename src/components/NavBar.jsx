            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <Nav.Link href="#education" className={activeLink === 'education' ? 'active navbar-link' : 'navbar-link'} onClick={()=>onUpdateActiveLink('education')}>
                            Education
                        </Nav.Link>
                    ...
                    <span className="navbar-text">
                        <div className="social-icon">
                            <a href="#lol"><img src={navIcon1} alt="" /></a>
                            <a href="#lol"><img src={navIcon2} alt="" /></a>
                            <a href="#lol"><img src={navIcon3} alt="" /></a>
                        </div>
                    </span>
                </Navbar.Collapse>
            </Container>
